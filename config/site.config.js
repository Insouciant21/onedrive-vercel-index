...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'sdrive@Insouciant21.xyz',
  ...
  email: 'mailto:Insouciant21@outlook.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Insouciant21',
    },
  ],
